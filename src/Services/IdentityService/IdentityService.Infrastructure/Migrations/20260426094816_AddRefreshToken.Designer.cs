...
namespace IdentityService.Infrastructure.Migrations
{
    ...
    [Migration("20260426094816_AddRefreshToken")]
            ...
            modelBuilder.Entity("IdentityService.Domain.Entities.SubscriptionEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DurationDays = 36500,
                            Name = "Free",
                            Permissions = new List<string> { "tank:read", "tank:create", "tank:update", "tank:delete", "tank:limit:1", "device:control", "auto:rule:create", "auto:rule:limit:5", "auto:schedule:create", "data:view", "notify:log:read", "notify:log:write", "account:update", "account:view" },
                            Price = 0m
                        },
                        new
                        {
                            ...
                            DurationDays = 31,
                            Name = "Professional",
                            Permissions = new List<string> { "tank:read", "tank:create", "tank:update", "tank:delete", "tank:limit:10", "device:control", "auto:rule:create", "auto:rule:limit:10", "auto:schedule:create", "data:view", "data:history", "notify:tg", "notify:log:read", "notify:log:write", "notify:reminder", "account:update", "account:view" },
                            Price = 9.99m
                        },
                        new
                        {
                            ...
                            DurationDays = 31,
                            Name = "Elite",
                            Permissions = new List<string> { "tank:read", "tank:create", "tank:update", "tank:delete", "tank:limit:unlim", "device:control", "device:manual", "auto:rule:create", "auto:rule:limit:unlim", "auto:schedule:create", "auto:vacation", "data:view", "data:history", "data:diag", "data:rt", "notify:log:read", "notify:log:write", "notify:reminder", "notify:email", "notify:tg" },
                            Price = 19.99m
                        });
                });
