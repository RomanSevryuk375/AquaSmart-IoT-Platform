...
namespace Control.Application.Features.Ecosystem.Queries.GetAllEcosystems;
    ...
    IMapper mapper) : IRequestHandler<GetAllEcosystemsQuery, IReadOnlyList<EcosystemDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        IReadOnlyList<EcosystemEntity> ecosystems = await ecosystemRepository.GetAllAsync(
            specification,
            cancellationToken);
