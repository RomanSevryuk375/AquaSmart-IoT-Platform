...
public abstract class BaseRepository<T>(NotificationDbContext dbContext) : IRepository<T> where T : class, IEntity
{
    private readonly DbSet<T> _set = dbContext.Set<T>();
    protected NotificationDbContext Context => dbContext;
